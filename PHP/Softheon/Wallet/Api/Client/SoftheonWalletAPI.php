...
final class SoftheonWalletAPI
{
     ...
     * @return array
     */
    public function getBin($cardNumber)
    {
        return $this->_GetBin_operation->call(['cardNumber' => $cardNumber]);
    }
    /**
        ...
        'paths' => [
            ...
            '/v1/subscriptions' => [
                ...
                'post' => [
                    ...
                    'responses' => [
                        '200' => ['schema' => ['$ref' => '#/definitions/SubscriptionResponceModel']],
                        '400' => [],
                        '409' => []
                    ]
                ]
            ...
            '/v1/wallet/{walletId}/CreditCard' => ['post' => [
            ...
            '/v1/wallet/{walletId}/BankAccount' => ['post' => [
            ...
            '/v1/wallet/{walletId}/CreditCard/{walletCreditCardId}' => ['delete' => [
            ...
            '/v1/wallet/{walletId}/BankAccount/{walletBankAcctId}' => ['delete' => [
