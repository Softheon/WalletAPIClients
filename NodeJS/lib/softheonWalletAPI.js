...
function _getBankAccountByToken(token, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/bankaccounts/{token}';
...
function _getBankAccountsByReferenceId(referenceId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/bankaccounts';
  let queryParameters = [];
...
function _updateBankAccount(updateBankAccountModel, options, callback) {
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    let statusCode = response.statusCode;
    if (statusCode !== 204 && statusCode !== 400 && statusCode !== 401) {
      let error = new Error(responseBody);
      error.statusCode = response.statusCode;
      error.request = msRest.stripRequest(httpRequest);
      error.response = msRest.stripResponse(response);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getBin(binRequest, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Validate
  try {
    if (binRequest === null || binRequest === undefined) {
      throw new Error('binRequest cannot be null or undefined.');
    }
  } catch (error) {
    return callback(error);
  }
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/bins';
  ...
  try {
    if (binRequest !== null && binRequest !== undefined) {
      let requestModelMapper = new client.models['BinRequestModel']().mapper();
      requestModel = client.serialize(requestModelMapper, binRequest, 'binRequest');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(binRequest, null, 2)}.`);
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
...
function _getCheckout(checkoutId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/checkouts';
  let queryParameters = [];
...
function _getCreditCardsByReferenceId(referenceId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/creditcards';
  let queryParameters = [];
  queryParameters.push('referenceId=' + encodeURIComponent(referenceId));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
...
function _getPayment(id, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/payments/{id}';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getPaymentsByReferenceId(options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    if (referenceId !== null && referenceId !== undefined && typeof referenceId.valueOf() !== 'string') {
      throw new Error('referenceId must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/payments';
  let queryParameters = [];
...
function _getRefunds(id, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/payments/{id}/refunds';
  requestUrl = requestUrl.replace('{id}', encodeURIComponent(id.toString()));
...
function _getSubscription(id, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/subscriptions/{id}';
...
function _getSubscriptionsByReferenceId(referenceId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/subscriptions';
  let queryParameters = [];
  queryParameters.push('referenceId=' + encodeURIComponent(referenceId));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
...
function _updateSubscription(updateSubscriptionModel, options, callback) {
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    let statusCode = response.statusCode;
    if (statusCode !== 204 && statusCode !== 401) {
      let error = new Error(responseBody);
      error.statusCode = response.statusCode;
      error.request = msRest.stripRequest(httpRequest);
      error.response = msRest.stripResponse(response);
...
function _createSubscription(subscriptionRequest, options, callback) {
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    let statusCode = response.statusCode;
    if (statusCode !== 200 && statusCode !== 400 && statusCode !== 401 && statusCode !== 409) {
      let error = new Error(responseBody);
      error.statusCode = response.statusCode;
      error.request = msRest.stripRequest(httpRequest);
      error.response = msRest.stripResponse(response);
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['SubscriptionResponseModel']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
...
function _getWallet(walletId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/wallet/{walletId}';
...
function _getWalletByReferenceId(referenceId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/wallet';
  let queryParameters = [];
  queryParameters.push('referenceId=' + encodeURIComponent(referenceId));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
...
function _addWalletCreditCard(walletId, request, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/wallet/{walletId}/CreditCard';
  requestUrl = requestUrl.replace('{walletId}', encodeURIComponent(walletId.toString()));
...
function _addWalletBankAccount(walletId, request, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/wallet/{walletId}/BankAccount';
  requestUrl = requestUrl.replace('{walletId}', encodeURIComponent(walletId.toString()));
...
function _removeWalletBankAccount(walletId, walletBankAcctId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/wallet/{walletId}/BankAccount/{walletBankAcctId}';
  requestUrl = requestUrl.replace('{walletId}', encodeURIComponent(walletId.toString()));
...
function _removeWalletCreditCard(walletId, walletCreditCardId, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v2/wallet/{walletId}/CreditCard/{walletCreditCardId}';
  requestUrl = requestUrl.replace('{walletId}', encodeURIComponent(walletId.toString()));
...
class SoftheonWalletAPI extends ServiceClient {
  ...
  constructor(baseUri, options) {
    ...
    if (!this.baseUri) {
      this.baseUri = 'https://api-model.softheon.com/payments';
    }
   ...
   * @reject {Error} - The error object.
   */
  getBinWithHttpOperationResponse(binRequest, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getBin(binRequest, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getBin(binRequest, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getBin(binRequest, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getPaymentsByReferenceIdWithHttpOperationResponse(options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getPaymentsByReferenceId(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getPaymentsByReferenceId(options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getPaymentsByReferenceId(options, optionalCallback);
    }
  }
...
module.exports['default'] = SoftheonWalletAPI;
module.exports.SoftheonWalletAPI = SoftheonWalletAPI;
module.exports.SoftheonWalletAPIModels = models;
