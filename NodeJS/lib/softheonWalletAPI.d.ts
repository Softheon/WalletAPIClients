...
export default class SoftheonWalletAPI extends ServiceClient {
  /**
   * @class
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  updateBankAccountWithHttpOperationResponse(updateBankAccountModel: models.UpdateBankAccountModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  updateBankAccount(updateBankAccountModel: models.UpdateBankAccountModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
  updateBankAccount(updateBankAccountModel: models.UpdateBankAccountModel, callback: ServiceCallback<void>): void;
  updateBankAccount(updateBankAccountModel: models.UpdateBankAccountModel, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
   ...
   *
   * @param {object} binRequest The bin request.
   *
   * @param {string} binRequest.cardNumber The number on the credit card.
   *
   * @param {object} [options] Optional Parameters.
   *
   * @param {object} [options.customHeaders] Headers that will be added to the
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  getBinWithHttpOperationResponse(binRequest: models.BinRequestModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.Bin>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  getBin(binRequest: models.BinRequestModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.Bin>;
  getBin(binRequest: models.BinRequestModel, callback: ServiceCallback<models.Bin>): void;
  getBin(binRequest: models.BinRequestModel, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.Bin>): void;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  updateCreditCardWithHttpOperationResponse(updateCreditCardModel: models.UpdateCreditCardModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  updateCreditCard(updateCreditCardModel: models.UpdateCreditCardModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
  updateCreditCard(updateCreditCardModel: models.UpdateCreditCardModel, callback: ServiceCallback<void>): void;
  updateCreditCard(updateCreditCardModel: models.UpdateCreditCardModel, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
   ...
   * @param {object} [options] Optional Parameters.
   *
   * @param {string} [options.referenceId] Gets or sets the reference identifier.
   *
   * @param {date} [options.minDate] Gets or sets the minimum date.
   *
   * @param {date} [options.maxDate] Gets or sets the maximum date.
   *
   * @param {object} [options.customHeaders] Headers that will be added to the
   * request
   *
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  getPaymentsByReferenceIdWithHttpOperationResponse(options?: { referenceId? : string, minDate? : Date, maxDate? : Date, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.PaymentModel[]>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  getPaymentsByReferenceId(options?: { referenceId? : string, minDate? : Date, maxDate? : Date, customHeaders? : { [headerName: string]: string; } }): Promise<models.PaymentModel[]>;
  getPaymentsByReferenceId(callback: ServiceCallback<models.PaymentModel[]>): void;
  getPaymentsByReferenceId(options: { referenceId? : string, minDate? : Date, maxDate? : Date, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.PaymentModel[]>): void;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  updateSubscriptionWithHttpOperationResponse(updateSubscriptionModel: models.UpdateSubscriptionModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  updateSubscription(updateSubscriptionModel: models.UpdateSubscriptionModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
  updateSubscription(updateSubscriptionModel: models.UpdateSubscriptionModel, callback: ServiceCallback<void>): void;
  updateSubscription(updateSubscriptionModel: models.UpdateSubscriptionModel, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
   ...
   * @returns {Promise} A promise is returned
   *
   * @resolve {HttpOperationResponse<SubscriptionResponseModel>} - The deserialized result object.
   *
   * @reject {Error|ServiceError} - The error object.
   */
  createSubscriptionWithHttpOperationResponse(subscriptionRequest: models.SubscriptionRequestModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.SubscriptionResponseModel>>;
   ...
   * {Promise} A promise is returned.
   *
   *                      @resolve {SubscriptionResponseModel} - The deserialized result object.
   *
   *                      @reject {Error|ServiceError} - The error object.
   *
   * {ServiceCallback} optionalCallback(err, result, request, response)
   ...
   *                      {Error|ServiceError}  err        - The Error object if an error occurred, null otherwise.
   *
   *                      {SubscriptionResponseModel} [result]   - The deserialized result object if an error did not occur.
   *                      See {@link SubscriptionResponseModel} for more
   *                      information.
   *
   *                      {WebResource} [request]  - The HTTP Request object if an error did not occur.
   *
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  createSubscription(subscriptionRequest: models.SubscriptionRequestModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.SubscriptionResponseModel>;
  createSubscription(subscriptionRequest: models.SubscriptionRequestModel, callback: ServiceCallback<models.SubscriptionResponseModel>): void;
  createSubscription(subscriptionRequest: models.SubscriptionRequestModel, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.SubscriptionResponseModel>): void;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  createWalletWithHttpOperationResponse(model: models.WalletRequestModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<number>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  createWallet(model: models.WalletRequestModel, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<number>;
  createWallet(model: models.WalletRequestModel, callback: ServiceCallback<number>): void;
  createWallet(model: models.WalletRequestModel, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<number>): void;
...
export { SoftheonWalletAPI, models as SoftheonWalletAPIModels };
