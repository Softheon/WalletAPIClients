...
module WalletApiV2
  ...
  class SoftheonWalletAPI < MsRest::ServiceClient
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @base_url = base_url || 'https://api-model.softheon.com/payments'
    ...
    def get_bank_account_by_token_async(token, custom_headers:nil)
      ...
      path_template = 'v2/bankaccounts/{token}'
      ...
      promise = promise.then do |result|
        ...
        unless status_code == 200 || status_code == 401 || status_code == 403 || status_code == 404
        ...
        if status_code == 200
          begin
            ...
            result_mapper = WalletApiV2::Models::BankAccountModel.mapper()
    ...
    def get_bank_accounts_by_reference_id_async(reference_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        status_code = http_response.status
        response_content = http_response.body
        unless status_code == 200 || status_code == 401
          error_model = JSON.load(response_content)
          fail MsRest::HttpOperationError.new(result.request, http_response, error_model)
        end
    ...
    def update_bank_account_async(update_bank_account_model, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::UpdateBankAccountModel.mapper()
      ...
      promise = promise.then do |result|
        ...
        status_code = http_response.status
        response_content = http_response.body
        unless status_code == 204 || status_code == 400 || status_code == 401
          error_model = JSON.load(response_content)
          fail MsRest::HttpOperationError.new(result.request, http_response, error_model)
        end
    ...
    def create_bank_account_async(bank_account_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::BankAccountRequestModel.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::BankAccountResponseModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    # @param bin_request [BinRequestModel] The bin request.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Bin] operation results.
    #
    def get_bin(bin_request, custom_headers:nil)
      response = get_bin_async(bin_request, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def get_bin_with_http_info(bin_request, custom_headers:nil)
      get_bin_async(bin_request, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_bin_async(bin_request, custom_headers:nil)
      fail ArgumentError, 'bin_request is nil' if bin_request.nil?
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::BinRequestModel.mapper()
      request_content = self.serialize(request_mapper,  bin_request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'v2/bins'
      ...
      promise = promise.then do |result|
        ...
        status_code = http_response.status
        response_content = http_response.body
        unless status_code == 200 || status_code == 401 || status_code == 404
          error_model = JSON.load(response_content)
          fail MsRest::HttpOperationError.new(result.request, http_response, error_model)
        end
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::Bin.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_checkout_async(checkout_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::CheckoutResponseModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_checkout_async(model, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::CheckoutRequestModel.mapper()
    ...
    def update_credit_card_async(update_credit_card_model, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::UpdateCreditCardModel.mapper()
    ...
    def create_credit_card_async(credit_card_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::CreditCardRequestModel.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::CreditCardResponseModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_payment_async(id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::PaymentModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    # @param reference_id [String] Gets or sets the reference identifier.
    # @param min_date [DateTime] Gets or sets the minimum date.
    # @param max_date [DateTime] Gets or sets the maximum date.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Array] operation results.
    #
    def get_payments_by_reference_id(reference_id:nil, min_date:nil, max_date:nil, custom_headers:nil)
      response = get_payments_by_reference_id_async(reference_id:reference_id, min_date:min_date, max_date:max_date, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def get_payments_by_reference_id_with_http_info(reference_id:nil, min_date:nil, max_date:nil, custom_headers:nil)
      get_payments_by_reference_id_async(reference_id:reference_id, min_date:min_date, max_date:max_date, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_payments_by_reference_id_async(reference_id:nil, min_date:nil, max_date:nil, custom_headers:nil)
    ...
    def create_payment_async(payment_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::PaymentRequestModel.mapper()
    ...
    def get_refunds_async(id, custom_headers:nil)
      ...
      request_headers = {}
      request_headers['Content-Type'] = 'application/json; charset=utf-8'
      path_template = 'v2/payments/{id}/refunds'
    ...
    def create_refund_async(id, refund_request_model, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::RefundRequestModel.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::RefundResultModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_subscription_async(id, custom_headers:nil)
      ...
      request_headers = {}
      request_headers['Content-Type'] = 'application/json; charset=utf-8'
      path_template = 'v2/subscriptions/{id}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::SubscriptionModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_subscription_async(update_subscription_model, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::UpdateSubscriptionModel.mapper()
      ...
      promise = promise.then do |result|
        ...
        status_code = http_response.status
        response_content = http_response.body
        unless status_code == 204 || status_code == 401
          error_model = JSON.load(response_content)
          fail MsRest::HttpOperationError.new(result.request, http_response, error_model)
        end
    ...
    # will be added to the HTTP request.
    #
    # @return [SubscriptionResponseModel] operation results.
    #
    ...
    def create_subscription_async(subscription_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::SubscriptionRequestModel.mapper()
      ...
      promise = promise.then do |result|
        ...
        status_code = http_response.status
        response_content = http_response.body
        unless status_code == 200 || status_code == 400 || status_code == 401 || status_code == 409
          error_model = JSON.load(response_content)
          fail MsRest::HttpOperationError.new(result.request, http_response, error_model)
        end
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::SubscriptionResponseModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_wallet_async(wallet_id, custom_headers:nil)
      ...
      request_headers = {}
      request_headers['Content-Type'] = 'application/json; charset=utf-8'
      path_template = 'v2/wallet/{walletId}'
      ...
      promise = promise.then do |result|
        ...
        status_code = http_response.status
        response_content = http_response.body
        unless status_code == 200 || status_code == 400 || status_code == 401 || status_code == 404
          error_model = JSON.load(response_content)
          fail MsRest::HttpOperationError.new(result.request, http_response, error_model)
        end
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = WalletApiV2::Models::WalletModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_wallet_async(model, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::WalletRequestModel.mapper()
      request_content = self.serialize(request_mapper,  model)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def add_wallet_credit_card_async(wallet_id, request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::WalletCreditCardRequestModel.mapper()
      request_content = self.serialize(request_mapper,  request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'v2/wallet/{walletId}/CreditCard'
    ...
    def add_wallet_bank_account_async(wallet_id, request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = WalletApiV2::Models::WalletBankAccountRequestModel.mapper()
      request_content = self.serialize(request_mapper,  request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'v2/wallet/{walletId}/BankAccount'
    ...
    def remove_wallet_bank_account_async(wallet_id, wallet_bank_acct_id, custom_headers:nil)
      ...
      request_headers = {}
      request_headers['Content-Type'] = 'application/json; charset=utf-8'
      path_template = 'v2/wallet/{walletId}/BankAccount/{walletBankAcctId}'
    ...
    def remove_wallet_credit_card_async(wallet_id, wallet_credit_card_id, custom_headers:nil)
      ...
      request_headers = {}
      request_headers['Content-Type'] = 'application/json; charset=utf-8'
      path_template = 'v2/wallet/{walletId}/CreditCard/{walletCreditCardId}'
