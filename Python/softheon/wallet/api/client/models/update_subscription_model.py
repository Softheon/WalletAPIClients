...
class UpdateSubscriptionModel(Model):
    ...
    def __init__(self, id, name, run_day, state, payment_type, payment_token, amount_type, description=None, properties=None, amount=None, amount_web_service_url=None, callback_web_service_url=None, end_date=None, reference_id=None):
        super(UpdateSubscriptionModel, self).__init__()
        self.id = id
        self.name = name
